...
if TYPE_CHECKING:
    ...
    from rich_rst._vendor.docutils.transforms import Transformer, Transform
    from rich_rst._vendor.docutils.utils import Reporter
...
class document(Root, Element):
    ...
    def __init__(self,
        ...
        import rich_rst._vendor.docutils.transforms
