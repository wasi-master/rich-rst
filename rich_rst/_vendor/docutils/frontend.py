...
from rich_rst._vendor.docutils import io, utils
...
if TYPE_CHECKING:
    ...
    from rich_rst._vendor.docutils import SettingsSpec, _OptionTuple, _SettingsSpecTuple
    from rich_rst._vendor.docutils.io import StrPath
